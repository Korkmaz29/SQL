...
--ORNEK1: Maasi 4000’den cok olan isci isimlerini ve 5000 liradan fazla maaþ
--alinan sehirleri gosteren sorguyu yaziniz. maaslarý sonradan
...
select isim as isim_sehir, maas from personel--tekrarý olmadýðý için union alll kullanmadýk
...
--ORNEK Honda tofas ve ford da ortak çalýþan
select isim from personel--tek satýrda bir kaç veri isteniyorsa AND ile, farklý satýrlardan ortaklýk isteniyorsa INTERSECT
where sirket='Honda'
INTERSECT
...
select isim,sehir from personel
where sehir='Izmir';
--MINUS ta UNION gibi tekrarlý satýrlardan sadeec birini yazdýrýr.
