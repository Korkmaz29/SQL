...
--SORGU icinde calýsan sorguya subquery denir.
...
--AS takýsýyla istediðimiz hedef sütünun adýný deðiþtirebiliriz
...
--ORNEK5: Her þirketin ismini, personel sayýsýný ve o þirkete ait personelin
  ...
  WHERE sirket_adi=sirket) AS MAX_MAAS,(SELECT MIN (maas)FROM personel
