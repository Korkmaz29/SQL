...
GROUP BY isim;--isim isim grupla, her ismi bir kere yaz , o isimdeki meyve sayýlarýný topla ve ilgili ismin satýrýnda göster
...
--MAX urun miktarlarini, MAX urun miktarina göre SIRALAYARAK listeyen sorguyu yazýnýz.
...
--KOMUTLARIN SIRALAMASI AÞAÐIDAKÝ GÝBÝ OLMALI,KOMUT HÝYEÞARÞÝSÝ
/*
  =>SELECT FROM
...
/* ============================= DISTINCT =====================================
DISTINCT cümleciði bir SORGU ifadesinde benzer olan satýrlarý filtrelemek
...
select SUM (DISTINCT urun_miktari) toplam_urun_miktari from manav;
